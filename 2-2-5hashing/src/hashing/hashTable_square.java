...
public class hashTable_square implements Map {
	...
	public hashTable_square(int capacity,float loadFactor) {
	...
	public hashTable_square(int capacity) {
	...
	private void printName(){
		System.out.println("=================================");
		System.out.println("hashTable_Square");
	}
	public void print(){
		printName();
